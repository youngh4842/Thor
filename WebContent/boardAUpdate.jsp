...
<body>
	...
	<section>
		...
		<form action="boardAUpdateOk.common" method="post">
			<input type="hidden" name="a_num" value="${aVo.a_num }" />
			<table>
				<tr>
					<td>제목</td>
					<td><input type="text" name="title" size="35" value="${aVo.a_title }" /></td>
				</tr>
				<tr>
					<td>내용</td>
					<td><textarea name="content" rows="15" cols="80">${aVo.a_content }</textarea></td>
				</tr>
				<tr>
					<td colspan="2">
