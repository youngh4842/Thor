...
<body>
	...
	<section>
		...
		<form action="boardQUpdateOk.common" method="post">
			<input type="hidden" name="q_num" value="${qVo.q_num }" />
			<table>
				<tr>
					<td>제목</td>
					<td><input type="text" name="title" size="35" value="${qVo.q_title }" /></td>
				</tr>
				<tr>
					<td>내용</td>
					<td><textarea name="content" rows="15" cols="80">${qVo.q_content }</textarea></td>
				</tr>
				<tr>
					<td colspan="2">
